...
<body>
    ...
    <div class="">
        <form action="index_guestPIC.php" method="post" class="forms space30 contents">
        <div class="self-assessment-form">
            ...
            <!-- Phone -->
                <br><br><label for="fphone">Mobile Phone</label> <br>
                <input class="form-input" type="text" id="fname" name="fnip">
            <!-- Division Unit -->
                <br><br><label for="fdiv">Company Name</label> <br>
                <input class="form-input" type="text" name="fdiv">
        </div>
