...
<body>
    <?php
        ...
        if (isset($_POST["submit"])){
            ...
            setcookie("asses2", $fnik, time() + 30);
            setcookie("asses3", $status, time() + 30);
            if($correct == 6){
                header("Location: http://localhost/blimanagement/SelfAssessment/AfterSubmit/green.php");
            }else if($correct <= 5 && $correct >= 4){
                header("Location: http://localhost/blimanagement/SelfAssessment/AfterSubmit/yellow.php");
            }else if($correct < 4){
                header("Location: http://localhost/blimanagement/SelfAssessment/AfterSubmit/red.php");
            }
            $correct = 0;
        }
     ?>
    ...
    <div class="">
        <form action="index_guest.php" method="post" class="forms space30 contents">
        ...
        <div class="self-assessment-questions">
            <div class="scroll-bg">
                ...
                <center><button class="submit" name="submit">Submit</button></center>
            </div>
        </div>
        </form>
